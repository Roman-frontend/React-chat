...
const ConversationInputHeader_jsx_1 = require('./ConversationInputHeader/ConversationInputHeader');
...
function Conversation(props) {
  ...
  function inputHeader() {
    if ((closeBtnReplyMsg || closeBtnChangeMsg) && popupMessage) {
      return (
        <ConversationInputHeader_jsx_1.ConversationInputHeader
          popupMessage={popupMessage}
  ...
  const setHeader = (0, react_1.useCallback)(() => {
    return activeChannelId ? (
      <ConversationHeaderChannel_jsx_1.ConversationHeaderChannel
      ...
      <ConversationHeaderDrMsg_jsx_1.ConversationHeaderDrMsg />
    );
  ...
  return (
    <system_1.Box>
      ...
      {inputHeader()}
      <ConversationActionsMessage_jsx_1.ConversationActionsMessage
        openPopup={openPopup}
        setOpenPopup={setOpenPopup}
        setCloseBtnReplyMsg={setCloseBtnReplyMsg}
        inputRef={inputRef}
      ...
      <system_1.Box style={{ display: openPopup && 'none' }}>
        <InputUpdateMessages_jsx_1.InputUpdateMessages
          popupMessage={popupMessage}
          inputRef={inputRef}
          changeMessageRef={changeMessageRef}
