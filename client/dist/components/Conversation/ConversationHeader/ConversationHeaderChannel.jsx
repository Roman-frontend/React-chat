...
const ChannelsRightBar_1 = __importDefault(
  require('../../SetsUser/Channels/ChannelsRightBar')
);
const ConversationHeaderChannel = (props) => {
  ...
  const [modalIsShowsMembers, setModalIsShowsMembers] = (0, react_1.useState)(
    false
  );
  const [isOpenRightBarChannels, setIsOpenRightBarChannels] = (0,
  ...
  const [addMemberToChannel] = (0, client_1.useMutation)(
    queryes_1.ADD_MEMBER_CHANNEL,
    {
      update: (cache, { data: { channel } }) => {
        ...
        if (
          ...
          const channelsWithChannelHasMember = dChannels.userChannels.map(
            (userChannel) => {
              if (userChannel && userChannel.id === channel.addMember.id) {
                return Object.assign(Object.assign({}, userChannel), {
                  members: channel.addMember.members,
                });
              }
              return userChannel;
            }
          ...
          cache.writeQuery({
            ...
            data: Object.assign(Object.assign({}, dChannels), {
              userChannels: channelsWithChannelHasMember,
            }),
          });
        }
      },
    ...
    <div style={{ background: theme.palette.primary.main }}>
      ...
      >
        ...
        <Grid_1.default
          item
          xs={1}
          style={{ textAlign: 'center', margin: '0px 8px' }}
        >
          <GroupAdd_1.default
      ...
      <ConversationMembers_1.ConversationMembers
        activeChannel={activeChannel}
      ...
      />
      <AddPeopleToChannel_1.AddPeopleToChannel
        chatNameRef={chatNameRef}
        doneInvite={doneInvite}
        modalAddPeopleIsOpen={modalAddPeopleIsOpen}
        setModalAddPeopleIsOpen={setModalAddPeopleIsOpen}
