...
const HeaderProfile_jsx_1 = __importDefault(
  require("./HeaderProfile/HeaderProfile.jsx")
);
...
function Header(props) {
  ...
  const { currentTheme, setTheme } = (0, react_1.useContext)(
    App_1.CustomThemeContext
  );
  const menuId = "primary-search-account-menu";
  const { t, i18n } = (0, react_i18next_1.useTranslation)();
  const [isOpenRightBarUser, setIsOpenRightBarUser] = (0, react_1.useState)(
    false
  );
      ...
      >
        <Toolbar_1.default>
          ...
          <material_1.Grid item xs={2}>
            <HeaderStyles_jsx_1.MaterialUISwitch
              sx={{ m: 1 }}
              checked={!isDark}
          ...
          <material_1.Grid item xs={1}>
            <BootstrapTooltip
              ...
              TransitionComponent={Zoom_1.default}
              placement="bottom"
            >
              <Button_1.default
                style={{
