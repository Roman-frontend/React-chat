...
exports.MaterialUISwitch = exports.AppBar = void 0;
...
exports.AppBar = (0, styles_1.styled)(AppBar_1.default, {
    shouldForwardProp: (prop) => prop !== 'isOpenLeftBar',
})(({ theme, isOpenLeftBar }) => (Object.assign({ zIndex: theme.zIndex.drawer + 1, transition: theme.transitions.create(['width', 'margin'], {
...
exports.MaterialUISwitch = (0, styles_1.styled)(Switch_1.default)(({ theme }) => ({
    width: 62,
    height: 34,
    padding: 7,
