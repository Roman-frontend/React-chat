...
exports.AddPeopleToChannel = (0, styles_2.withStyles)(styles)((props) => {
    const { chatNameRef, isErrorInPopap, modalAddPeopleIsOpen, setModalAddPeopleIsOpen, doneInvite, classes, } = props;
    ...
    return (<>
      <Dialog_1.default sx={{
        ...
        }} open={modalAddPeopleIsOpen} onClose={() => setModalAddPeopleIsOpen(false)} aria-labelledby='form-dialog-title'>
        ...
        <SelectPeople_jsx_1.SelectPeople closePopap={closePopap} isErrorInPopap={isErrorInPopap} notInvitedRef={notInvitedRef.current} done={doneInvite}/>
      </Dialog_1.default>
    </>);
});
