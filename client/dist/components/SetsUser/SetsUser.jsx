...
function SetsUser(props) {
  ...
  const [modalAddChannelIsOpen, setModalAddChannelIsOpen] = (0,
  ...
  (0, react_1.useEffect)(() => {
    ...
    prevActiveChatIdRef.current = (0, reactiveVars_1.activeChatId)()
      .activeChannelId
  ...
  return (
    <div style={styles.leftBar}>
      ...
      />
      <DirectMessages_jsx_1.DirectMessages
        isOpenLeftBar={isOpenLeftBar}
