...
const SignUpPage_js_1 = __importDefault(require("./pages/SignUpPage/SignUpPage.js"));
const SignInPage_js_1 = require("./pages/SignInPage/SignInPage.js");
const Chat_js_1 = require("./pages/Chat/Chat.js");
...
function routesCreater() {
    return exports.routes.map((route) => {
        if (route.private) {
            return <PrivateRoute_1.PrivateRoute key={(0, nanoid_1.nanoid)()} {...route}/>;
        }
        return <Publi_OnlyRoute_1.PubliсOnlyRoute key={(0, nanoid_1.nanoid)()} {...route}/>;
    });
}
